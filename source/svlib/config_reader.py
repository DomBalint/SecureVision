...
class ConfigReader:
    ...
    def __init__(self, path_configs: str = None):
        ...
        self.svt_config = conf_

    @property
    def svt_config(self):
        return self._svt_config

    @svt_config.setter
    def svt_config(self, configuration: dict):
        self._svt_config = configuration
    ...
    def get(self, key1: str, key2: str = None) -> str:
        ...
        """
        if not key2:
            return self.svt_config.get(key1)
        else:
            return self.svt_config.get(key1).get(key2)
