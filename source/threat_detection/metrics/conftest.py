...
desired_precisions = [0.6552, 0.6552, 0.4545, 0.2973, 0.1429, 0.0909]
params = list(tuple(zip(thresholds, desired_precisions)))


@pytest.fixture(scope='module', params=params)
def precision_data(request):
    thr_prec = request.param
    return gt_boxes, preds_sorted, thr_prec
